...
\usepackage{babel}
\usepackage[UKenglish,abbreviations,xfrench]{foreign}
...
% \clearpage\printglossary
% \clearpage\printglossary[type=\acronymtype]
...
\glsresetall
% \cpresetrulenumber
\include{chapters/litreview/litreview}
\glsresetall
% \cpresetrulenumber
...
\glsresetall
% \cpresetrulenumber
\include{chapters/medianfilter/cml}
\glsresetall
% \cpresetrulenumber
