...
\documentclass[newzealand,10pt,partial,onehalfspace,final]{aucklandthesis}
...
\usepackage{listings,alltt,pdfpages}
...
\usepackage[group-digits=integer,group-separator={,},group-minimum-digits=4,tight-spacing=true]{siunitx}
\usepackage{fixme}
\fxusetheme{color}
...
\usepackage[ruled,vlined,linesnumbered,nofillcomment,algochapter]{algorithm2e}
