...
\usepackage{amsmath,amssymb,cpsystems}
\usepackage{listings,minted,alltt}
\usepackage[binary-units]{siunitx}
\usepackage{url,subcaption,clrscode3e,backnaur,threeparttable} % look at removing all of these --- they were only introduced to make the G Col Rep stuff build
\usepackage{pgfplots}
...
\usepackage[
    ...
    % \addbibresource{chapters/tsp/biblio.bib}
    % \addbibresource{chapters/gcol/biblio.bib}
...
% \title{Bio-inspired Solutions to Selected Graph and Image Problems}
...
% \glsresetall
% \input{chapters/choiceoflang/choiceoflang}
% \glsresetall
% \input{chapters/concprop/concprop}
% \glsresetall
