...
%
\documentclass[10pt,partial,draft,doublespace]{aucklandthesis}
% \documentclass[10pt,partial,doublespace]{aucklandthesis}
% \documentclass[10pt,partial,singlespace]{aucklandthesis}
% \documentclass[10pt,partial]{aucklandthesis}
%
...
\usepackage{amsmath,amssymb,cpsystems,url,xcolor}
...
\usepackage{siunitx}
\usepackage{threeparttable} % look at removing all of these --- they were only introduced to make the G Col Rep stuff build
\usepackage{fixme}
\fxusetheme{color}
...
\input{tex/abstract} % it's in a separate file
...
\glsresetall
\cpresetrulenumber
\input{chapters/cpsystems/cpsystems}
\glsresetall
\cpresetrulenumber
\input{chapters/tsp/tsp}
\glsresetall
\cpresetrulenumber
\input{chapters/gcol/g-col-rep}
\glsresetall
\cpresetrulenumber
\input{chapters/nmp/nmp}
% \glsresetall
% \cpresetrulenumber
...
\glsresetall
\cpresetrulenumber
\input{chapters/medianfilter/cml}
\glsresetall
\cpresetrulenumber
