%-----------------------------------------------------------------------------------
\section{Data structures in \glsentrytext{cps}}\label{sec:cps:datastructures}
%-----------------------------------------------------------------------------------

This \namecref{sec:cps:datastructures} sketches the design of some high-level data structures, 
...
\subsubsection{Less than and greater than in promoters and inhibitors}

\begin{anfxnote}
Compare variables in those using set operations.
\end{anfxnote}
