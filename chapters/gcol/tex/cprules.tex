\section{\label{sec:gcol:cpsys}\glsfmttext{cps} solution to the \glsfmtlong{gcp-glossary}}
...
\subsection{\label{sec:gcol:sysinit}\glsfmtplural{cps} Initialisation}
...
\subsection{\label{sec:gcol:notation}\glsfmtplural{cps} Notation}
