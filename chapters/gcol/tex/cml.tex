\section{\label{sec:gcol:cml}Simple Kernel \texorpdfstring{\gls{ps}}{P systems} solution to the Graph Colouring problem in \texorpdfstring{\glsentrylong{cml-glossary}}{Concurrent ML}}
