...
\begin{figure}
    ...
    \caption[Diagram of the message-passing primitive in \glsentrylong{cml-glossary}]{\fxerror{Move this to the CML background section}{In \gls{cml}}, logical processing elements synchronously exchange values over channels.  When one processing element offers to give a value on a channel, and another offers to take a value on the same channel, they ‘rendezvous’ and exchange the value as a passed message.}
