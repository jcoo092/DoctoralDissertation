\section{\label{sec:gcol:cml}\texorpdfstring{\gls{skps}}{Simple Kernel P systems} solution to the Graph Colouring problem in \texorpdfstring{\glsentrylong{cml-glossary}}{Concurrent ML}}
