...
\end{tabular}%
\caption[\Glsxtrlong{skps} vs. \gls{cps} comparison]{\glsfmtname{skps} vs. \gls{cps}.  \gls{cps} do not have a concept of subcompartments in the same way as \gls{skps}, and thus has no entry for the maximum number of subcompartments.  This distinction is discussed in \cref{sec:gcol:diffsubcomp}}
...
\bottomrule
\end{tabular}
\caption{Comparison of known \gls{ps} solutions to the \glsentrylong{gcp-glossary}.  \(n\) is the number of nodes in the graph.}
