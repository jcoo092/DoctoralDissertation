...
In particular, this \lcnamecref{chap:lr} discusses \nameref{sec:lr:formalmodels}, \nameref{sec:lr:cml} and \nameref{sec:lr:mc}.  \Gls{mc} is, in fact, another model of concurrent computation, but given its central position in this work, it is given a dedicated separate \lcnamecref{sec:lr:mc}.  The same can be said about \gls{cps}, which is given its own \lcnamecref{chap:tsp}.
