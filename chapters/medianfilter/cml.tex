...
% \caption{\label{graph:median:medium}Comparative graph of runtimes for medium image across window sizes}
% \end{figure}
...
\end{axis}
\end{tikzpicture}
\caption{\label{graph:median:cmls}Plot of mean runtimes for the CML algorithm on different images sizes}
\end{figure}
