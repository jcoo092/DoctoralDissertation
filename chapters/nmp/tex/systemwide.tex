...
\begin{cprulesetfloat}
    ...
    \end{cpruleset}
    \caption[Complete ruleset for \gls{gs} \glsxtrlong{nmp}]{\label{ruleset:nmp:systemwide}Complete ruleset for \gls{gs} \gls{nmp}, using an oracle to perform update computations}
\end{cprulesetfloat}
