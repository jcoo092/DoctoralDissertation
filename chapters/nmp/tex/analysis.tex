...
% the first two lemmas may be combined ...
...
\begin{figure}
    ...
    \caption{Visualisation of the spread of `influence' from the centre \gls{pe} during \gls{nmp}.  The squares' value was computed by taking over the current messages the maximum, including a datum stored by the \gls{pe}}
...
\begin{figure}
    ...
    \caption{Visualisation of the spread of `influence' from the centre \gls{pe} during \gls{nmp}.  The squares' value was computed by taking over the current messages the maximum, including a datum stored by the \gls{pe}, and with delivery delays of two rounds on messages going to the left only}
...
\begin{figure}
    ...
    \caption{Visualisation of the spread of `influence' from the centre \gls{pe} during \gls{nmp}.  The squares' value was computed by taking over the current messages the maximum}
    \label{fig:nmp:max}
\end{figure}
...
\begin{figure}
    ...
    \caption{Visualisation of the spread of `influence' from the centre \gls{pe} during \gls{nmp}.  The squares' value was computed as by taking over the current messages the mean}
    \label{fig:nmp:mean}
\end{figure}
