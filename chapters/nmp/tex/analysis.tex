...
this \lcnamecref{sec:nmp:msgprops} considers only a \gls{fne} system and
...
\begin{remark}\label{remark:nmp:-2}
    ...
    These notes may be used to create alternate proofs of the main results.
