\section{\label{sec:tsp:algotsp}A \glsentrytext{cps} \glsfmtlong{tsp-glossary} Algorithm}
...
\cptuple{TSP}{\cpset{1}}{\cpset{c, c', e, f, h, p, p', r, s, t, u, v, z}}{\cpset{E \cup \cpset{\cpfunc{v}{V}}}}{\text{\cref{ruleset:tsp:tsp}}}{\cpset{s_1, s_2, s_3, s_4}}{s_1}
