...
\caption[A tree diagram representing all potential evolutions of the \gls{cps} \acrlong{tsp} algorithm on the graph in \cref{fig:tsp:ugraph}]{\label{fig:tsp:utree}Tree diagram of the algorithm in action}
\end{figure}
...
\end{cpobjects}
\caption[Starting set of subcells from \cref{fig:tsp:utree}]{\label{fig:tsp:obj1}Set of subcells from G in the skin membrane at the initial state}
\end{cpobjectsfloat}
