...
\caption[A tree diagram representing all potential evolutions of the \gls{cps} \glsxtrlong{tsp} algorithm on the graph in \cref{fig:tsp:ugraph}]{\label{fig:tsp:utree}Tree diagram of the algorithm in action on graph G}
\end{figure}
