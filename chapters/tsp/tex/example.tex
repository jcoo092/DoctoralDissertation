...
\begin{figure}
\centering
\includegraphics[width=1.0\textwidth]{chapters/tsp/figs/ugraph-figure1}
\caption[A tree diagram representing all potential evolutions of the \gls{cps} \acrlong{tsp} algorithm on the graph in \autoref{fig:tsp:ugraph}]{\label{fig:tsp:utree}Tree diagram of the algorithm in action}
\end{figure}
...
\end{cpobjects}
\caption[Starting set of subcells from \autoref{fig:tsp:utree}]{\label{fig:tsp:obj1}Set of subcells from G in the skin membrane at the initial state}
\end{cpobjectsfloat}
