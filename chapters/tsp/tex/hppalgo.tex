...
\begin{description}
    ...
    \cptermdef{f}{Arc start term.  Shows the ``from'' vertex for an arc in the digraph.}
    ...
    \cptermdef{t}{Arc end term.  Shows the ``to'' vertex for an arc in the digraph.}
