...
\begin{figure}[htbp]
    ...
    \caption[Progression of the synchronous echo algorithm]{Progression of the synchronous echo algorithm, starting from round zero before any messages are sent.  Arrows in red mean broadcast messages, while arrows in blue mean convergecast messages.}
