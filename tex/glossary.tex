...
\newdefacr{hcp}{HCP}{Hamiltonian Cycle Problem}{Closely related to the \glsdesc{hpp}.  In this problem, the Hamiltonian Path must also be a cycle, i.e. it ends back at the origin node.}
...
\newglossaryentry{cps}{name={cP~systems},description={A variant of P~systems created by Nicolescu.},plural={cP~system}}
